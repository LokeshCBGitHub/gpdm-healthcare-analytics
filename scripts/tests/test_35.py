...
TESTS = [
    ...
    ('claims% by date of birth year < 1960', 'percentage'),
    ('claims% by age >65', 'percentage'),
    ('% claims with pending', 'percentage'),
    ('claims with prior authorization compared to total volume as percentage of total', 'percentage'),
]
